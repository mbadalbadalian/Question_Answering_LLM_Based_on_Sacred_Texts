...
if __name__ == "__main__":
    ...
    train_loader_fine_tuned_filepath = 'Additional_Data/DistilBERT_fine_tuned_train_loader_fine_tuned.pth'
    test_loader_fine_tuned_filepath = 'Additional_Data/DistilBERT_fine_tuned_test_loader_fine_tuned.pth'
    ditilBERT_model_fine_tuned_filepath = 'Models/DistilBERT_model_fine_tuned'
    average_train_loss_fine_tuned_filename = 'Additional_Data/DistilBERT_fine_tuned_training_loss.pkl'
    average_test_loss_fine_tuned_filename = 'Additional_Data/DistilBERT_fine_tuned_test_loss.pkl'
    
    create_or_load_string_train_and_test_loader_fine_tuned = 'Create'
    
    #Main Code
    training_args = TrainingArguments(output_dir=ditilBERT_model_fine_tuned_filepath,num_train_epochs=5,per_device_train_batch_size=8,per_device_eval_batch_size=8,warmup_steps=500,weight_decay=0.01,logging_directory='./logs',save_total_limit=3)
