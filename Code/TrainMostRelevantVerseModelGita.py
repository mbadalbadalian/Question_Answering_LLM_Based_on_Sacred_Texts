...
def CreateBERTModelFineTuned(model,train_loader,test_loader,BERT_model_fine_tuned_filepath,average_train_loss_filename,average_test_loss_filename,num_epochs=5):
    ...
    for epoch in range(start_epoch,num_epochs):
        ...
        print(f"Epoch {epoch + 1}/{num_epochs}, Validation Loss: {average_test_loss}")
...
if __name__ == "__main__":
    #Variables
    ESV_Bible_DF_filepath = 'Additional_Data/Gita_DF.csv'
    prepared_Q_and_A_DF_filepath = 'Additional_Data/PreparedQ_and_A_Gita.csv'
    train_loader_filepath = 'Additional_Data/BERT_most_relevant_verse_fine_tuned_train_loader_fine_tuned_Gita.pth'
    test_loader_filepath = 'Additional_Data/BERT_most_relevant_verse_fine_tuned_test_loader_fine_tuned_Gita.pth'
    BERT_most_relevant_verse_model_fine_tuned_filepath = 'Models/BERT_most_relevant_verse_model_fine_tuned_Gita'
    average_train_loss_filename = 'Additional_Data/BERT_most_relevant_verse_fine_tuned_training_loss_Gita.pkl'
    average_test_loss_filename = 'Additional_Data/BERT_most_relevant_verse_fine_tuned_test_loss_Gita.pkl'    
